...
func _ready():
	...
	# Build the panel programmatically
	...
	add_slider(vbox, "Wave Height",     "amplitude",      0.0,   0.15,   0.005,  0.05, water_mat)
	add_slider(vbox, "Dampening",       "attenuation",    0.990, 0.9999, 0.0001, 0.999,sim_mat)
	add_slider(vbox, "Wave Amplitude",  "wave_amplitude", 0.0,   0.15,   0.005,  0.0,  sim_mat)
